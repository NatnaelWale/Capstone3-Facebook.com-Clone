...
function createPost(loggedInUserFullName, userBio, userAvatar, postImageSrc, commentId, lastCheck, userLikes, postId, token) {
    ...
    const authorDetails = createElement('div', null, `<p class="m-0 fw-bold">${loggedInUserFullName}</p><span class="text-muted fs-7">${timeDifferenceString}</span>`);
